...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { receiver_book_id: @exchange.receiver_book_id, sender_book_id: @exchange.sender_book_id, status: @exchange.status }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { receiver_book_id: @exchange.receiver_book_id, sender_book_id: @exchange.sender_book_id, status: @exchange.status }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
